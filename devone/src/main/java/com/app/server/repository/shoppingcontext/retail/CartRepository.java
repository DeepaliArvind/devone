...
public interface CartRepository<T> extends CommonUtilRepository {
    ...
    List<T> findByItemId(String itemId) throws Exception;

    List<T> findByUserId(String userId) throws Exception;

    T findById(String cartid) throws Exception;
}
