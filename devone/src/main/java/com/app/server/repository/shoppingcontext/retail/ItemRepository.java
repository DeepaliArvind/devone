...
public interface ItemRepository<T> extends CommonUtilRepository {
    ...
    List<T> findByProductId(String productId) throws Exception;

    T findById(String itemId) throws Exception;
}
