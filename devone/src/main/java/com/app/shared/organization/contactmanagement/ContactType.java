...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    private static final long serialVersionUID = 1483948517625L;
    ...
    public void setContactTypeIcon(String contactTypeIcon) {
        this.contactTypeIcon = contactTypeIcon;
    }
    ...
    public int hashCode() {
        ...
        if (contactTypeId == null) {
            ...
            hashcode = contactTypeId.hashCode();
        }
        return hashcode;
    }
