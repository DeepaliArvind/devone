...
@NamedQueries({ @javax.persistence.NamedQuery(name = "Gender.findAll", query = " select u from Gender u where u.systemInfo.activeStatus=1"), @javax.persistence.NamedQuery(name = "Gender.findById", query = "select e from Gender e where e.systemInfo.activeStatus=1 and e.genderId =:genderId") })
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {

    private static final long serialVersionUID = 1483948518111L;
