...
@NamedQueries({ @javax.persistence.NamedQuery(name = "Title.findAll", query = " select u from Title u where u.systemInfo.activeStatus=1"), @javax.persistence.NamedQuery(name = "Title.findById", query = "select e from Title e where e.systemInfo.activeStatus=1 and e.titleId =:titleId") })
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {

    private static final long serialVersionUID = 1483948518639L;
