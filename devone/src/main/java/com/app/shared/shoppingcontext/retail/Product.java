...
@NamedQueries({ @javax.persistence.NamedQuery(name = "Product.findAll", query = " select u from Product u where u.systemInfo.activeStatus=1"), @javax.persistence.NamedQuery(name = "Product.findById", query = "select e from Product e where e.systemInfo.activeStatus=1 and e.productId =:productId") })
public class Product implements Serializable, CommonEntityInterface, Comparator<Product> {

    private static final long serialVersionUID = 1483948531364L;

    @Column(name = "productIdDesc")
    @JsonProperty("productIdDesc")
    @NotNull
    @Size(min = 1, max = 256)
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((productIdDesc == null ? " " : productIdDesc));
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        try {
            com.app.shared.shoppingcontext.retail.Product other = (com.app.shared.shoppingcontext.retail.Product) obj;
            if (productId == null) {
                isEquals = false;
