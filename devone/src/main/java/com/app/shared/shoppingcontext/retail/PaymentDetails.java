...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "PaymentDetails", complexity = Complexity.MEDIUM)
@XmlRootElement
public class PaymentDetails implements EntityValidatorInterface, Serializable {

    private static final long serialVersionUID = 1483948815554L;
