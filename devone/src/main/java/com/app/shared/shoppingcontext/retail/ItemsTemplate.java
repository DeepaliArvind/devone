...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "1", comments = "ItemsTemplate", complexity = Complexity.MEDIUM)
@XmlRootElement
public class ItemsTemplate implements EntityValidatorInterface, Serializable {

    private static final long serialVersionUID = 1483948755955L;
