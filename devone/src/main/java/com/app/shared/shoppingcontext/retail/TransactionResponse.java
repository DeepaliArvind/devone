...
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "3", comments = "TransactionResponse", complexity = Complexity.MEDIUM)
@XmlRootElement
public class TransactionResponse implements EntityValidatorInterface, Serializable {

    private static final long serialVersionUID = 1483948815474L;
