Ext.define("Devone.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Devone.view.clouddrive.CloudDriveController',
	             'Devone.view.clouddrive.documentview.DocumentsView',
	             'Devone.view.clouddrive.drivedetails.DriveDetails',
	             //'Devone.view.clouddrive.documentview.DocumentListView'
	             ],
