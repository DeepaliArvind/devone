Ext.define('Devone.view.usermanagement.admin.AddUserDetails', {
	extend : 'Ext.form.Panel',
	xtype : 'addUserDetails',
	itemId : 'addUserDetails',
	requires : [ 'Devone.view.usermanagement.admin.AddUserDetailsController', 'Devone.view.usermanagement.admin.AddUserDetailsViewModel', 'Devone.model.AddUserDataModel',
	// 'Devone.p2.com.p2.model.Contacts.CoreContactsModel',
	// 'Devone.p2.com.p2.model.Authentication.UserModel',
	],
	...
	items : [ {
		...
		items : [ {
			...
			items : [ {
				...
				maxValue : 3600,
				allowBlank : false,
				bind : "{userDetail.sessionTimeout}"
			} ]
		}, {
			columnWidth : .50,
			defaults : {/* width:'95%', */
			...
			items : [ {
				...
				labelWidth : 120,
				checked : 0,
				bind : "{userDetail.allowMultipleLogin}",
				hidden : true
			} ]
		} ]
	} ],
