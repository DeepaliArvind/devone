Ext.define('Devone.view.usermanagement.admin.UserPasswordReset', {
	extend : 'Ext.form.Panel',
	requires : [ 'Devone.view.usermanagement.admin.UserPasswordResetController' ],
	...
	items : [ {
		 ...
		 */
			...
			text : 'isLocked',
			flex : 0.11,
			renderer : function(lockStatus) {
				var image = "images/user/unlock_icon.png";
				if (lockStatus == 1)
					image = "images/user/lock_icon.png";
