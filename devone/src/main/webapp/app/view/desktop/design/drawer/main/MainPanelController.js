Ext.define('Devone.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Devone.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Devone.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Devone.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Devone.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Devone.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Devone.view.clouddrive.CloudDrive");
    },
