Ext.define('Devone.view.appreportui.datagrid.DataGridViewController', {
...
//		var params = controller.getView().getStore().getProxy().extraParams;
		var params = Ext.clone(controller.getView().getStore().getProxy().extraParams);
	...
	openDrillDown : function(reportId, reportName, rptHrefQC,gridObj,targetObj) 
	{
		...
		if(targetObj.targetSrc=="tab"){
			...
			if(targetObj.type == "f"){
				...
				component= Ext.create(
						'Devone.view.appreportui.ReportView', {
							closable : true,
							drilled : true,		
							title : reportName,
							refId : reportId,
