 ...
 * 
 */
Ext.define('Devone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Devone.view.logalarm.mainscreen.AddLogAlarmController',
			'Devone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Devone.view.logalarm.mainscreen.AppAlarmPanel',
