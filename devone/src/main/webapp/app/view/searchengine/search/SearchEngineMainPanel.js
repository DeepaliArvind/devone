Ext.define('Devone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Devone.view.searchengine.search.NorthPanel', 'Devone.view.searchengine.search.SearchResult','Devone.view.searchengine.search.SearchEngineMainPanelController'],
