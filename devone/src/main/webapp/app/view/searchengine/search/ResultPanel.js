Ext
		.define(
				'Devone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Devone.view.searchengine.search.SearchEngineMainPanelController','Devone.view.searchengine.search.PanelHeaderField' ,'Devone.view.searchengine.search.ReportGridView','Devone.view.searchengine.search.ReportChartView','Devone.view.searchengine.search.documentView','Devone.view.searchengine.search.DouMeanView','Devone.view.googlemaps.map.MapPanel'],
