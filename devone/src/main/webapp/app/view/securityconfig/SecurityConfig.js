 ...
 * 
 */
Ext.define('Devone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Devone.view.securityconfig.SecurityConfigController',
			'Devone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
