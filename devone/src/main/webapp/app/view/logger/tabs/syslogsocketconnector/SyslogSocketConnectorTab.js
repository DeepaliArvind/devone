 ...
 * 
 */
Ext.define('Devone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Devone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
