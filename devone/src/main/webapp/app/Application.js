...
Ext.define('Devone.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Devone.view.databrowsercalendar.DBCalendar",
			"Devone.view.fw.component.CustomComboBox" ,"Devone.view.fw.component.TreeComponent",
			"Devone.view.fw.component.FileUploadComponent"],
	...
	stores : [ 'Devone.store.QueryCriteriaWidgetsStore' ],
