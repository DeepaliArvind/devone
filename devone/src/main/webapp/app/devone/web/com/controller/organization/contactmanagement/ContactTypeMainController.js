Ext.define('Devone.devone.web.com.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Devone.devone.shared.com.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: {
                    params: {
               ...
               listeners: {
                    load: function(storeObj, records, successful, eOpts) {
                         var tree = currentObject.view.down('#ContactTypeTree');
