Ext.define('Devone.devone.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Devone.devone.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: {
                    params: {
               ...
               listeners: {
                    load: function(storeObj, records, successful, eOpts) {
                         var tree = currentObject.view.down('#QuestionTree');
