Ext.define('Devone.devone.web.com.controller.organization.locationmanagement.CityMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Devone.devone.shared.com.model.organization.locationmanagement.CityModel',
               autoLoad: {
                    params: {
               ...
               listeners: {
                    load: function(storeObj, records, successful, eOpts) {
                         var tree = currentObject.view.down('#CityTree');
