Ext.define('Devone.devone.web.com.controller.organization.locationmanagement.TimezoneMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Devone.devone.shared.com.model.organization.locationmanagement.TimezoneModel',
               autoLoad: {
                    params: {
