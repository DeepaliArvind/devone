Ext.define('Devone.devone.web.com.controller.organization.contactmanagement.CoreContactsMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Devone.devone.shared.com.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: {
                    params: {
