...
public class TitleTestCase extends EntityTestCriteria {
    ...
    private Title createTitle(Boolean isSave) throws Exception {
        ...
        title.setTitles("vGUTs39In2yDYkWL1OrOzrYfnFlqAhw55N3D93ZWQ13Y7Mg1PV");
    ...
    public void test2Update() {
        try {
            ...
            title.setTitles("mjOcL3XcVrKFNB5FFXViXQY3pPja6y5nbIb9gc9Dn7bBIWvYee");
    ...
    public void test6Delete() {
        try {
            Assert.assertNotNull(map.get("TitlePrimaryKey"));
            titleRepository.remove((java.lang.String) map.get("TitlePrimaryKey"));
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    }
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "titles", ""));
