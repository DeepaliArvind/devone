Ext.define('Devone.view.smartdevice.reportview.dataview.DataView', {
	extend : 'Ext.panel.Panel',
	requires:['Devone.view.smartdevice.reportview.dataview.DataViewController','Devone.view.smartdevice.reportview.dataview.DataDetailViewModel'],
