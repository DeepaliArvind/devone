Ext.define('Devone.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Devone.view.smartdevice.reportview.datapointview.DataPointViewController'],
