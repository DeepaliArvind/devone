Ext.define('Devone.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Devone.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
