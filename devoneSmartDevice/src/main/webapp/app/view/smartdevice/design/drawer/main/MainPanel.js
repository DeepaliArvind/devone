Ext.define('Devone.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Devone.view.smartdevice.design.drawer.main.MainPanelController','Devone.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
