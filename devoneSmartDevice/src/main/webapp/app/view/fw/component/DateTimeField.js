 ...
 */
Ext.define('Devone.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Devone.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Devone.view.fw.component.DateTimePicker(o);
    },
    ...
    getValues : function(){
    	if (this.getSubmitValue() != "" && this.getSubmitValue() != null) {
    		var timezone = XA_TID;//Ext.util.ookies.get('XA_TID');
