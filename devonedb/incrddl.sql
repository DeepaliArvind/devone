...
CREATE TABLE `Product` ( `productId` VARCHAR(256) NOT NULL, `productIdDesc` VARCHAR(256) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`productId`));

CREATE TABLE `Item` ( `itemId` VARCHAR(256) NOT NULL, `productId` VARCHAR(256) NOT NULL, `itemName` VARCHAR(256) NOT NULL, `img` VARCHAR(256) NOT NULL, `stock` INT(10) NOT NULL, `price` DOUBLE(21,2) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`itemId`));

CREATE TABLE `Cart` ( `cartid` VARCHAR(256) NOT NULL, `itemId` VARCHAR(256) NOT NULL, `qty` INT(10) NOT NULL, `subTotal` DOUBLE(21,2) NOT NULL, `userId` VARCHAR(64) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`cartid`));

CREATE TABLE `OrderMain` ( `orderMainID` VARCHAR(256) NOT NULL, `orderDate` TIMESTAMP NULL DEFAULT NULL, `userId` VARCHAR(64) NULL DEFAULT NULL, `grandTotal` DOUBLE(21,2) NULL DEFAULT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`orderMainID`));

CREATE TABLE `OrderDetail` ( `orderMainID` VARCHAR(256) NOT NULL, `orderDetailId` VARCHAR(256) NOT NULL, `itemId` VARCHAR(256) NOT NULL, `qty` INT(10) NOT NULL, `subTotal` DOUBLE(21,2) NOT NULL, `createdBy` VARCHAR(64) NULL DEFAULT '-1', `createdDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `updatedBy` VARCHAR(64) NULL DEFAULT '-1', `updatedDate` TIMESTAMP NULL DEFAULT '2000-01-01 10:10:10', `versionId` INT(10) NULL DEFAULT '-1', `activeStatus` INT(1) NULL DEFAULT '1', `txnAccessCode` INT(10) NULL DEFAULT NULL, PRIMARY KEY (`orderDetailId`));
...
ALTER TABLE `Item` ADD CONSTRAINT FOREIGN KEY (`productId`) REFERENCES `Product`(`productId`);

ALTER TABLE `Cart` ADD CONSTRAINT FOREIGN KEY (`userId`) REFERENCES `UserDetail`(`userId`);

ALTER TABLE `Cart` ADD CONSTRAINT FOREIGN KEY (`itemId`) REFERENCES `Item`(`itemId`);

ALTER TABLE `OrderMain` ADD CONSTRAINT FOREIGN KEY (`userId`) REFERENCES `UserDetail`(`userId`);

ALTER TABLE `OrderDetail` ADD CONSTRAINT FOREIGN KEY (`orderMainID`) REFERENCES `OrderMain`(`orderMainID`);

ALTER TABLE `OrderDetail` ADD CONSTRAINT FOREIGN KEY (`itemId`) REFERENCES `Item`(`itemId`);
